...
//        dao.insert(comp1)
        ...
        Vaga vaga = new Vaga(1, "Dev Novo", "Teste", "Uberlandia", "MG", [comp1])
//        dao.insert(vaga)

//        dao.insert(candidato)

        Empresa empresa = new Empresa("Empresa Teste", "empresa@fake.com", "PR", "70670707", "CA", "12345678911111", "descricao", [comp1], "123456")
...
//        println(dao.listCompetencia())
        //dao.update("candidato", "nome", "Angela Martin", 5)
    }
}
